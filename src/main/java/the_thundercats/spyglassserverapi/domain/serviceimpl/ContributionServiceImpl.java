...
public class ContributionServiceImpl implements ContributionService {
    ...
    @Override
    public Contribution create(Contribution contribution) throws ResourceCreationException {
        Optional<Contribution> optional = contributionRepo.findById(contribution.getId());
        if(optional.isPresent())
            throw new ResourceCreationException("Contribution exists");
